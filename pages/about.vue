			...
			<div class="container-narrow">
				...
				<div class="about-info__bottom">
					<div class="paragraph">
						...
						<p class="description">
							모든 일에는 다 뜻이 있듯이 디자인[design:설계하다]에도 이유가 있어야 한다고 생각합니다. 사용성에 맞는 사고방식[100%]으로 작은 것에도 의미를 담고 숨겨진 재미를 추구합니다. 이러한 이유를 바탕으로 표현된 사람들의 관심을 이끌 수 있는 시각적인 비주얼[100%]이 더해져 사용자에게 더 좋은 경험을 선사하는, 200% 실현하는 크리에이터가 되고자 합니다.
						</p>
					</div>
					<div class="paragraph">
